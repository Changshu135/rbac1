<%@ page import="com.rbac.bean.Users" %>
    ...
    <nav class="navbar navbar-inverse navbar-static-top">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" id="company_logo" href="#"><c:if test='"${sessionScope.user}"!=""'>${sessionScope.user.realName}</c:if>
                    </a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="hrms-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    <li class="active">
                        <a href="#">访问控制实验 <span class="sr-only">(current)</span>  </a>
                    </li>
                    <!--
                    <li><a href="#">点菜</a></li>
                    <li><a href="#">点菜</a></li>
